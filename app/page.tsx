...
export default async function Home(){
  ...
  return <main className="guest-manual" id="top">
    ...
    <section className="manual-section" id="arrival"><div className="manual-heading"><p className="eyebrow">Start here</p><h2>Arrival, step by step.</h2><p>Keep this page open as you approach the building.</p></div><div className="arrival-steps">
      ...
      <article><span>02</span><div><div className="arrival-photo"><Image src="/self-checkin-guide.png" alt="Outdoor parking space" fill sizes="300px" style={{objectPosition:"center 39%"}}/></div><small>Park</small><h3>Parking space</h3><div className="access-number">{available(guide.parkingSpace)}</div><p>{available(guide.parking)}</p></div></article>
      <article><span>03</span><div><div className="arrival-photo"><Image src="/self-checkin-guide.png" alt="Building intercom and entrance code" fill sizes="300px" style={{objectPosition:"center 59%"}}/></div><small>Enter the building</small><h3>Building code</h3><div className="access-number">{available(guide.buildingCode)}</div>{guide.buildingCode?<CopyButton value={guide.buildingCode}/>:null}<p className="instruction-lines">{available(guide.buildingEntryInstructions)}</p></div></article>
      <article><span>04</span><div><div className="arrival-photo"><Image src="/self-checkin-guide.png" alt="Hallway leading to apartment 32" fill sizes="300px" style={{objectPosition:"center 79%"}}/></div><small>Find your door</small><h3>{guide.floor?`Floor ${guide.floor}`:"Apartment location"}{guide.apartmentNumber?` · ${guide.apartmentNumber}`:""}</h3><p>{available(guide.apartmentDirections)}</p></div></article>
