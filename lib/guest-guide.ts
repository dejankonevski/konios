...
export const defaultMessageTemplates: MessageTemplate[] = [
  ...
  },
  {
    ...
    category: "Arrival",
    content: "Hi {guestName}! Your check-in is today at {checkInTime}. Open the guest guide at {guideUrl} and enter PIN {code}. Do you need any assistance with arrival?",
  },
  {
    id: "tpl-4",
  ...
  { id:"tpl-7", title:"Exact location", category:"Arrival", content:"Hi {firstName}! The exact location is here: {guideUrl}. Enter PIN {code}, then tap Google Maps under the first arrival step." },
  ...
  { id:"tpl-10", title:"Late check-in available", category:"Arrival", content:"Hi {firstName}! Late check-in is possible because access is self-service. Please keep the guest guide and PIN {code} available, and message us if you need help." },
  ...
  { id:"tpl-15", title:"Early check-in available", category:"Arrival", content:"Good news, {firstName}! The apartment is ready earlier than expected. You may check in now at {guideUrl} using PIN {code}." },
