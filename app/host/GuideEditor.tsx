...
const groups: { title: string; note: string; fields: [keyof GuestGuide, string, "input" | "textarea"][] }[] = [
  { title:"Arrival & access", note:"Everything guests need between the street and the apartment door.", fields:[["propertyName","Property name","input"],["address","Full address","input"],["mapsUrl","Google or Apple Maps link","input"],["directions","Directions / landmark notes","textarea"],["buildingCode","Building entrance code","input"],["lockboxCode","Key lockbox code","input"],["lockboxInstructions","Where the lockbox is and how to use it","textarea"],["floor","Floor","input"],["apartmentNumber","Apartment number / door","input"]] },
  { title:"Stay essentials", note:"The details guests usually ask for first.", fields:[["wifiName","Wi-Fi network","input"],["wifiPassword","Wi-Fi password","input"],["hostName","Host name","input"],["hostPhone","Host phone with country code","input"],["parking","Parking instructions","textarea"]] },
